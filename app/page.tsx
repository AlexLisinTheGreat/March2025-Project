...
export default function Home() {
	return (
		<section className="flex flex-col items-center justify-center gap-4 py-8 md:py-10">
			<p>
				Start building! this is an example / template site to start
				with.
			</p>
			<p>
			...
			<div>
				...
				<p>
					Do <strong>not</strong> delete or modify the following files
				...
				<ul className="list-disc ml-6">
					...
					<li>
						<Code>/types/index.ts</Code> (can modify but likely
						won&apos;t need to)
					</li>
					<li>
